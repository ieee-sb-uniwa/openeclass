...
$langMonthlyReportInfo = "Παρουσιάζονται συγκεντρωτικά στοιχεία (μαθήματα, χρήστες) των τελευταίων 12 μηνών.";
...
$langGradebookInsAut = "αυτόματη καταχώριση βαθμού";
$langGradebookInsMan = "μη αυτόματη καταχώριση βαθμού";
...
$langInfoStudReq = "Αν επιθυμείτε να έχετε πρόβαση στην πλατφόρμα με δικαιώματα χρήστη, παρακαλώ συμπληρώστε την παρακάτω αίτηση. Η αίτηση θα σταλεί στον υπεύθυνο διαχειριστή ο οποίος θα δημιουργήσει το λογαριασμό και θα σας στείλει τα στοιχεία μέσω ηλεκτρονικού ταχυδρομείου.";
...
$langOpenDelosRequireAuth = "Απαιτείται ξεχωριστή αυθεντικοποίηση με το OpenDelos, παρακαλώ πατήστε";
...
$langWorkFileLimit = 'Αρχεία (μέχρι %d)';
...
$langImportGradesError = 'Δεν έγινε εισαγωγή των βαθμών λόγω των παρακάτω σφαλμάτων.
...
$langEndPeerReview = "Η περίοδος βαθμολόγησης έληξε, δεν μπορείτε να βαθμολογήσετε.";
...
$langAnalyticsElementUpdateSuccess = "Η αλλαγή έγινε με επιτυχία!";
